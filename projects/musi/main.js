...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmMemory = wasmExports["de"];
    updateMemoryViews();
    wasmTable = wasmExports["ge"];
    addOnInit(wasmExports["ee"]);
...
var ASM_CONSTS = {
  ...
  57902: () => document.getElementById("canvas").width,
  57954: () => parseInt(document.getElementById("canvas").style.width),
  58022: () => {
  ...
  58168: () => document.getElementById("canvas").width,
  58220: () => screen.width,
  58245: () => {
    document.exitFullscreen();
  },
  ...
  58451: () => document.getElementById("canvas").width,
  58503: () => parseInt(document.getElementById("canvas").style.width),
  58571: () => {
    if (document.fullscreenElement) return 1;
  },
  58617: () => document.getElementById("canvas").width,
  58669: () => screen.width,
  58694: () => {
    if (document.fullscreenElement) return 1;
  },
  58740: () => document.getElementById("canvas").width,
  58792: () => screen.width,
  58817: () => {
    document.exitFullscreen();
  },
  ...
  58890: () => document.getElementById("canvas").width,
  58942: () => parseInt(document.getElementById("canvas").style.width),
  59010: () => {
    document.exitFullscreen();
  },
  59037: () => screen.width,
  59062: () => screen.height,
  59088: () => window.screenX,
  59115: () => window.screenY,
  59142: ($0) => {
  ...
  64912: ($0) => miniaudio.get_device_by_index($0).webaudio.sampleRate,
  64978: ($0) => {
...
var wasmImports = {
  ...
  R: _emscripten_get_element_css_size,
  ...
  Dd: _emscripten_glBlendEquation,
  Cd: _emscripten_glBlendEquationSeparate,
  Bd: _emscripten_glBlendFunc,
  Ad: _emscripten_glBlendFuncSeparate,
  zd: _emscripten_glBufferData,
  ...
  O: _emscripten_glDeleteQueriesEXT,
  ...
  Yd: _emscripten_glGetQueryivEXT,
  ...
  Xa: _emscripten_memcpy_js,
  Pa: _emscripten_resize_heap,
  ua: _emscripten_sample_gamepad_data,
  ...
  aa: _emscripten_set_resize_callback_on_thread,
  ...
  Q: _glfwDestroyWindow,
  z: _glfwGetPrimaryMonitor,
  b: _glfwGetTime,
  oa: _glfwGetVideoModes,
  qa: _glfwInit,
  ca: _glfwMakeContextCurrent,
  ha: _glfwSetCharCallback,
  da: _glfwSetCursorEnterCallback,
  fa: _glfwSetCursorPosCallback,
  ka: _glfwSetDropCallback,
  ra: _glfwSetErrorCallback,
  ia: _glfwSetKeyCallback,
  ga: _glfwSetMouseButtonCallback,
  ea: _glfwSetScrollCallback,
  ja: _glfwSetWindowContentScaleCallback,
  la: _glfwSetWindowFocusCallback,
  ma: _glfwSetWindowIconifyCallback,
  S: _glfwSetWindowShouldClose,
...
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["ee"])();
var _main = (Module["_main"] = (a0, a1) =>
  (_main = Module["_main"] = wasmExports["fe"])(a0, a1));
var _malloc = (a0) => (_malloc = wasmExports["he"])(a0);
var _free = (a0) => (_free = wasmExports["ie"])(a0);
...
var _ma_malloc_emscripten = (Module["_ma_malloc_emscripten"] = (a0, a1) =>
  (_ma_malloc_emscripten = Module["_ma_malloc_emscripten"] = wasmExports["ke"])(
    a0,
    a1
  ));
var _ma_free_emscripten = (Module["_ma_free_emscripten"] = (a0, a1) =>
  (_ma_free_emscripten = Module["_ma_free_emscripten"] = wasmExports["le"])(
    a0,
    a1
  ));
...
var _ma_device_process_pcm_frames_playback__webaudio = (Module[
  ...
  (_ma_device_process_pcm_frames_playback__webaudio = Module[
    ...
    wasmExports["ne"])(a0, a1, a2));
var ___start_em_js = (Module["___start_em_js"] = 65665);
var ___stop_em_js = (Module["___stop_em_js"] = 65738);
var calledRun;
